...
pub enum DestinyPeriodDestinyTalentNodeState {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for DestinyPeriodDestinyTalentNodeState {
...
impl Default for DestinyPeriodDestinyTalentNodeState {
    fn default() -> DestinyPeriodDestinyTalentNodeState {
        Self::Variant0
    }
}
