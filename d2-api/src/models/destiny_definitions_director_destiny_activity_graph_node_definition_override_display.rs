...
/// DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinitionOverrideDisplay : The node *may* have display properties that override the active Activity's display properties.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinitionOverrideDisplay {
...
impl DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinitionOverrideDisplay {
    /// The node *may* have display properties that override the active Activity's display properties.
    pub fn new() -> DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinitionOverrideDisplay {
