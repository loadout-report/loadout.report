...
pub enum DestinyPeriodDestinyGatingScope {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for DestinyPeriodDestinyGatingScope {
...
impl Default for DestinyPeriodDestinyGatingScope {
    fn default() -> DestinyPeriodDestinyGatingScope {
        Self::Variant0
    }
}
