...
pub struct UserGetBungieNetUserById200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<crate::models::UserPeriodGeneralUser>>,
...
impl UserGetBungieNetUserById200Response {
    pub fn new() -> UserGetBungieNetUserById200Response {
