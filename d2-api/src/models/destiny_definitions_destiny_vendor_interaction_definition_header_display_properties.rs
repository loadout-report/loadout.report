...
/// DestinyDefinitionsDestinyVendorInteractionDefinitionHeaderDisplayProperties : The header for the interaction dialog.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyVendorInteractionDefinitionHeaderDisplayProperties {
...
impl DestinyDefinitionsDestinyVendorInteractionDefinitionHeaderDisplayProperties {
    /// The header for the interaction dialog.
    pub fn new() -> DestinyDefinitionsDestinyVendorInteractionDefinitionHeaderDisplayProperties {
