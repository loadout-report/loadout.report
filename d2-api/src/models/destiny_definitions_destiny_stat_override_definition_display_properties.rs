...
/// DestinyDefinitionsDestinyStatOverrideDefinitionDisplayProperties : The display properties to show instead of the base DestinyStatDefinition display properties.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyStatOverrideDefinitionDisplayProperties {
...
impl DestinyDefinitionsDestinyStatOverrideDefinitionDisplayProperties {
    /// The display properties to show instead of the base DestinyStatDefinition display properties.
    pub fn new() -> DestinyDefinitionsDestinyStatOverrideDefinitionDisplayProperties {
