...
/// DestinyPeriodDefinitionsPeriodDestinyActivityRewardDefinition : Activities can refer to one or more sets of tooltip-friendly reward data. These are the definitions for those tooltip friendly rewards.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodDefinitionsPeriodDestinyActivityRewardDefinition {
    /// The header for the reward set, if any.
    #[serde(rename = "rewardText", skip_serializing_if = "Option::is_none")]
...
impl DestinyPeriodDefinitionsPeriodDestinyActivityRewardDefinition {
    ...
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyActivityRewardDefinition {
