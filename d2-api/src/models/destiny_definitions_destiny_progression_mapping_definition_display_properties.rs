...
/// DestinyDefinitionsDestinyProgressionMappingDefinitionDisplayProperties : Infrequently defined in practice. Defer to the individual progressions' display properties.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyProgressionMappingDefinitionDisplayProperties {
...
impl DestinyDefinitionsDestinyProgressionMappingDefinitionDisplayProperties {
    /// Infrequently defined in practice. Defer to the individual progressions' display properties.
    pub fn new() -> DestinyDefinitionsDestinyProgressionMappingDefinitionDisplayProperties {
