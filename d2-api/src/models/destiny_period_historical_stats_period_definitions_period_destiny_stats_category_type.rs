...
pub enum DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodDestinyStatsCategoryType {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodDestinyStatsCategoryType {
...
impl Default for DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodDestinyStatsCategoryType {
    fn default() -> DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodDestinyStatsCategoryType {
        Self::Variant0
    }
}
