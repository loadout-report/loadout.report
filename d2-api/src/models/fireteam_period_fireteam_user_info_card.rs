...
pub struct FireteamPeriodFireteamUserInfoCard {
    #[serde(rename = "FireteamDisplayName", skip_serializing_if = "Option::is_none")]
    pub fireteam_display_name: Option<String>,
    #[serde(rename = "FireteamMembershipType", skip_serializing_if = "Option::is_none")]
    pub fireteam_membership_type: Option<i32>,
...
impl FireteamPeriodFireteamUserInfoCard {
    pub fn new() -> FireteamPeriodFireteamUserInfoCard {
        FireteamPeriodFireteamUserInfoCard {
            fireteam_display_name: None,
            fireteam_membership_type: None,
