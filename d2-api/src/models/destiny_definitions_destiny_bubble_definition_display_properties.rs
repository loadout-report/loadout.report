...
/// DestinyDefinitionsDestinyBubbleDefinitionDisplayProperties : The display properties of this bubble, so you don't have to look them up in a separate list anymore.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyBubbleDefinitionDisplayProperties {
...
impl DestinyDefinitionsDestinyBubbleDefinitionDisplayProperties {
    /// The display properties of this bubble, so you don't have to look them up in a separate list anymore.
    pub fn new() -> DestinyDefinitionsDestinyBubbleDefinitionDisplayProperties {
