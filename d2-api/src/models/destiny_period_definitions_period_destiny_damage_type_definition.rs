...
/// DestinyPeriodDefinitionsPeriodDestinyDamageTypeDefinition : All damage types that are possible in the game are defined here, along with localized info and icons as needed.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodDefinitionsPeriodDestinyDamageTypeDefinition {
    #[serde(rename = "displayProperties", skip_serializing_if = "Option::is_none")]
    pub display_properties: Option<Box<crate::models::DestinyDefinitionsDestinyDamageTypeDefinitionDisplayProperties>>,
...
impl DestinyPeriodDefinitionsPeriodDestinyDamageTypeDefinition {
    /// All damage types that are possible in the game are defined here, along with localized info and icons as needed.
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyDamageTypeDefinition {
