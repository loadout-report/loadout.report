...
pub struct GroupV2ApproveAllPending200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<crate::models::EntitiesPeriodEntityActionResult>>,
...
impl GroupV2ApproveAllPending200Response {
    pub fn new() -> GroupV2ApproveAllPending200Response {
