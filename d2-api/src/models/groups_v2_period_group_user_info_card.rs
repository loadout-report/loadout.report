...
pub struct GroupsV2PeriodGroupUserInfoCard {
    ...
    #[serde(rename = "LastSeenDisplayName", skip_serializing_if = "Option::is_none")]
    pub last_seen_display_name: Option<String>,
    /// The platform of the LastSeenDisplayName
    #[serde(rename = "LastSeenDisplayNameType", skip_serializing_if = "Option::is_none")]
    pub last_seen_display_name_type: Option<i32>,
...
impl GroupsV2PeriodGroupUserInfoCard {
    pub fn new() -> GroupsV2PeriodGroupUserInfoCard {
