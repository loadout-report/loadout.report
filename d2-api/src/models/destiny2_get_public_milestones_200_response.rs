...
pub struct Destiny2GetPublicMilestones200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodMilestonesPeriodDestinyPublicMilestone>>,
...
impl Destiny2GetPublicMilestones200Response {
    pub fn new() -> Destiny2GetPublicMilestones200Response {
