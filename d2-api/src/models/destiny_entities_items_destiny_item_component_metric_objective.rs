...
/// DestinyEntitiesItemsDestinyItemComponentMetricObjective : The objective progress for the currently-selected metric definition, to be displayed on the emblem nameplate.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyEntitiesItemsDestinyItemComponentMetricObjective {
...
impl DestinyEntitiesItemsDestinyItemComponentMetricObjective {
    /// The objective progress for the currently-selected metric definition, to be displayed on the emblem nameplate.
    pub fn new() -> DestinyEntitiesItemsDestinyItemComponentMetricObjective {
