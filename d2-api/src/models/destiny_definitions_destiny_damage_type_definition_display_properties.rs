...
/// DestinyDefinitionsDestinyDamageTypeDefinitionDisplayProperties : The description of the damage type, icon etc...



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyDamageTypeDefinitionDisplayProperties {
...
impl DestinyDefinitionsDestinyDamageTypeDefinitionDisplayProperties {
    /// The description of the damage type, icon etc...
    pub fn new() -> DestinyDefinitionsDestinyDamageTypeDefinitionDisplayProperties {
