...
pub struct DestinyPeriodComponentsPeriodItemsPeriodDestinyItemReusablePlugsComponent {
    ...
    pub plugs: Option<::std::collections::HashMap<String, Vec<crate::models::DestinyPeriodSocketsPeriodDestinyItemPlugBase>>>,
}

impl DestinyPeriodComponentsPeriodItemsPeriodDestinyItemReusablePlugsComponent {
    pub fn new() -> DestinyPeriodComponentsPeriodItemsPeriodDestinyItemReusablePlugsComponent {
