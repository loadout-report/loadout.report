...
pub enum IgnoresPeriodIgnoreLength {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for IgnoresPeriodIgnoreLength {
...
impl Default for IgnoresPeriodIgnoreLength {
    fn default() -> IgnoresPeriodIgnoreLength {
        Self::Variant0
    }
}
