...
/// DestinyDefinitionsEnergyTypesDestinyEnergyTypeDefinitionDisplayProperties : The description of the energy type, icon etc...



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsEnergyTypesDestinyEnergyTypeDefinitionDisplayProperties {
...
impl DestinyDefinitionsEnergyTypesDestinyEnergyTypeDefinitionDisplayProperties {
    /// The description of the energy type, icon etc...
    pub fn new() -> DestinyDefinitionsEnergyTypesDestinyEnergyTypeDefinitionDisplayProperties {
