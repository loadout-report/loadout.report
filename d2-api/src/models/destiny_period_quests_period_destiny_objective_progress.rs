...
/// DestinyPeriodQuestsPeriodDestinyObjectiveProgress : Returns data about a character's status with a given Objective. Combine with DestinyObjectiveDefinition static data for display purposes.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodQuestsPeriodDestinyObjectiveProgress {
...
impl DestinyPeriodQuestsPeriodDestinyObjectiveProgress {
    /// Returns data about a character's status with a given Objective. Combine with DestinyObjectiveDefinition static data for display purposes.
    pub fn new() -> DestinyPeriodQuestsPeriodDestinyObjectiveProgress {
