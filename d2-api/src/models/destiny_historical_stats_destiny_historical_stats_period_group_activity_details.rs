...
/// DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroupActivityDetails : If the period group is for a specific activity, this property will be set.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroupActivityDetails {
...
impl DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroupActivityDetails {
    /// If the period group is for a specific activity, this property will be set.
    pub fn new() -> DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroupActivityDetails {
