...
/// DestinyPeriodEntitiesPeriodVendorsPeriodDestinyVendorComponent : This component contains essential/summary information about the vendor.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodEntitiesPeriodVendorsPeriodDestinyVendorComponent {
    ...
    pub progression: Option<Box<crate::models::DestinyEntitiesVendorsDestinyVendorComponentProgression>>,
    ...
    #[serde(rename = "vendorLocationIndex", skip_serializing_if = "Option::is_none")]
    pub vendor_location_index: Option<i32>,
    ...
    #[serde(rename = "seasonalRank", skip_serializing_if = "Option::is_none")]
...
impl DestinyPeriodEntitiesPeriodVendorsPeriodDestinyVendorComponent {
    /// This component contains essential/summary information about the vendor.
    pub fn new() -> DestinyPeriodEntitiesPeriodVendorsPeriodDestinyVendorComponent {
