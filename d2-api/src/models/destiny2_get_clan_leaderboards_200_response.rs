...
pub struct Destiny2GetClanLeaderboards200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<::std::collections::HashMap<String, ::std::collections::HashMap<String, crate::models::DestinyPeriodHistoricalStatsPeriodDestinyLeaderboard>>>,
...
impl Destiny2GetClanLeaderboards200Response {
    pub fn new() -> Destiny2GetClanLeaderboards200Response {
