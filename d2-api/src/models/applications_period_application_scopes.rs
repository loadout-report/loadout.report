...
pub enum ApplicationsPeriodApplicationScopes {
    #[serde(rename = "1")]
    Variant1,
    #[serde(rename = "2")]
    Variant2,
...
impl ToString for ApplicationsPeriodApplicationScopes {
...
impl Default for ApplicationsPeriodApplicationScopes {
    fn default() -> ApplicationsPeriodApplicationScopes {
        Self::Variant1
    }
}
