...
pub struct TokensGetBungieRewardsForUser200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<::std::collections::HashMap<String, crate::models::TokensPeriodBungieRewardDisplay>>,
...
impl TokensGetBungieRewardsForUser200Response {
    pub fn new() -> TokensGetBungieRewardsForUser200Response {
