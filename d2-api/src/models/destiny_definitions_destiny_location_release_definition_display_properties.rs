...
/// DestinyDefinitionsDestinyLocationReleaseDefinitionDisplayProperties : Sadly, these don't appear to be populated anymore (ever?)



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyLocationReleaseDefinitionDisplayProperties {
...
impl DestinyDefinitionsDestinyLocationReleaseDefinitionDisplayProperties {
    /// Sadly, these don't appear to be populated anymore (ever?)
    pub fn new() -> DestinyDefinitionsDestinyLocationReleaseDefinitionDisplayProperties {
