...
pub enum DestinyPeriodVendorItemStatus {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for DestinyPeriodVendorItemStatus {
...
impl Default for DestinyPeriodVendorItemStatus {
    fn default() -> DestinyPeriodVendorItemStatus {
        Self::Variant0
    }
}
