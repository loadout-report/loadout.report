...
/// DestinyComponentsPresentationDestinyPresentationNodeComponentObjective : An optional property: presentation nodes MAY have objectives, which can be used to infer more human readable data about the progress. However, progressValue and completionValue ought to be considered the canonical values for progress on Progression Nodes.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyComponentsPresentationDestinyPresentationNodeComponentObjective {
...
impl DestinyComponentsPresentationDestinyPresentationNodeComponentObjective {
    ...
    pub fn new() -> DestinyComponentsPresentationDestinyPresentationNodeComponentObjective {
        DestinyComponentsPresentationDestinyPresentationNodeComponentObjective {
            objective_hash: None,
