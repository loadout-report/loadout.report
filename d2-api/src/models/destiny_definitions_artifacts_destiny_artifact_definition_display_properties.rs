...
/// DestinyDefinitionsArtifactsDestinyArtifactDefinitionDisplayProperties : Any basic display info we know about the Artifact. Currently sourced from a related inventory item, but the source of this data is subject to change.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsArtifactsDestinyArtifactDefinitionDisplayProperties {
...
impl DestinyDefinitionsArtifactsDestinyArtifactDefinitionDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsArtifactsDestinyArtifactDefinitionDisplayProperties {
