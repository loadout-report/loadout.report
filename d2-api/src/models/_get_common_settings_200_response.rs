...
pub struct GetCommonSettings200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<crate::models::CommonPeriodModelsPeriodCoreSettingsConfiguration>>,
...
impl GetCommonSettings200Response {
    pub fn new() -> GetCommonSettings200Response {
