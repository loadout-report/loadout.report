...
/// DestinyPeriodEntitiesPeriodCharactersPeriodDestinyCharacterProgressionComponent : This component returns anything that could be considered \"Progression\" on a user: data where the user is gaining levels, reputation, completions, rewards, etc...



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodEntitiesPeriodCharactersPeriodDestinyCharacterProgressionComponent {
    ...
    pub progressions: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodDestinyProgression>>,
    ...
    pub factions: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodProgressionPeriodDestinyFactionProgression>>,
    ...
    pub milestones: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodMilestonesPeriodDestinyMilestone>>,
    ...
    pub quests: Option<Vec<crate::models::DestinyPeriodQuestsPeriodDestinyQuestStatus>>,
    ...
    #[serde(rename = "uninstancedItemObjectives", skip_serializing_if = "Option::is_none")]
    pub uninstanced_item_objectives: Option<::std::collections::HashMap<String, Vec<crate::models::DestinyPeriodQuestsPeriodDestinyObjectiveProgress>>>,
    ...
    #[serde(rename = "uninstancedItemPerks", skip_serializing_if = "Option::is_none")]
    pub uninstanced_item_perks: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodEntitiesPeriodItemsPeriodDestinyItemPerksComponent>>,
    ...
    pub seasonal_artifact: Option<Box<crate::models::DestinyEntitiesCharactersDestinyCharacterProgressionComponentSeasonalArtifact>>,
}

impl DestinyPeriodEntitiesPeriodCharactersPeriodDestinyCharacterProgressionComponent {
    /// This component returns anything that could be considered \"Progression\" on a user: data where the user is gaining levels, reputation, completions, rewards, etc...
    pub fn new() -> DestinyPeriodEntitiesPeriodCharactersPeriodDestinyCharacterProgressionComponent {
