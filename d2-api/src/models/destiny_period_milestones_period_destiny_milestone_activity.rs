...
/// DestinyPeriodMilestonesPeriodDestinyMilestoneActivity : Sometimes, we know the specific activity that the Milestone wants you to play. This entity provides additional information about that Activity and all of its variants. (sometimes there's only one variant, but I think you get the point)



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodMilestonesPeriodDestinyMilestoneActivity {
...
impl DestinyPeriodMilestonesPeriodDestinyMilestoneActivity {
    ...
    pub fn new() -> DestinyPeriodMilestonesPeriodDestinyMilestoneActivity {
