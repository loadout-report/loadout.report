...
/// DestinyPeriodDefinitionsPeriodDestinyVendorItemQuantity : In addition to item quantity information for vendor prices, this also has any optional information that may exist about how the item's quantity can be modified. (unfortunately not information that is able to be read outside of the BNet servers, but it's there)



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodDefinitionsPeriodDestinyVendorItemQuantity {
...
impl DestinyPeriodDefinitionsPeriodDestinyVendorItemQuantity {
    ...
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyVendorItemQuantity {
