...
pub struct DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphDefinition {
    /// These represent the visual \"nodes\" on the map's view. These are the activities you can click on in the map.
    #[serde(rename = "nodes", skip_serializing_if = "Option::is_none")]
    pub nodes: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphNodeDefinition>>,
    /// Represents one-off/special UI elements that appear on the map.
    #[serde(rename = "artElements", skip_serializing_if = "Option::is_none")]
    pub art_elements: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphArtElementDefinition>>,
    ...
    pub connections: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphConnectionDefinition>>,
    ...
    #[serde(rename = "displayObjectives", skip_serializing_if = "Option::is_none")]
    pub display_objectives: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphDisplayObjectiveDefinition>>,
    ...
    #[serde(rename = "displayProgressions", skip_serializing_if = "Option::is_none")]
    pub display_progressions: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphDisplayProgressionDefinition>>,
    /// Represents links between this Activity Graph and other ones.
    #[serde(rename = "linkedGraphs", skip_serializing_if = "Option::is_none")]
    pub linked_graphs: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyLinkedGraphDefinition>>,
...
impl DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphDefinition {
    /// Represents a Map View in the director: be them overview views, destination views, or other.  They have nodes which map to activities, and other various visual elements that we (or others) may or may not be able to use.  Activity graphs, most importantly, have nodes which can have activities in various states of playability.  Unfortunately, activity graphs are combined at runtime with Game UI-only assets such as fragments of map images, various in-game special effects, decals etc... that we don't get in these definitions.  If we end up having time, we may end up trying to manually populate those here: but the last time we tried that, before the lead-up to D1, it proved to be unmaintainable as the game's content changed. So don't bet the farm on us providing that content in this definition.
    pub fn new() -> DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphDefinition {
        DestinyPeriodDefinitionsPeriodDirectorPeriodDestinyActivityGraphDefinition {
            nodes: None,
            art_elements: None,
            connections: None,
