...
pub struct ForumGetTopicsPaged200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Box<crate::models::ForumPeriodPostSearchResponse>>,
...
impl ForumGetTopicsPaged200Response {
    pub fn new() -> ForumGetTopicsPaged200Response {
