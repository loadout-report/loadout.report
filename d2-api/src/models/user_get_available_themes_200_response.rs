...
pub struct UserGetAvailableThemes200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<crate::models::ConfigPeriodUserTheme>>,
...
impl UserGetAvailableThemes200Response {
    pub fn new() -> UserGetAvailableThemes200Response {
