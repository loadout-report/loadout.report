...
pub struct DestinyPeriodDefinitionsPeriodMilestonesPeriodDestinyMilestoneActivityDefinition {
    ...
    #[serde(rename = "conceptualActivityHash", skip_serializing_if = "Option::is_none")]
    pub conceptual_activity_hash: Option<i32>,
    ...
    pub variants: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodDefinitionsPeriodMilestonesPeriodDestinyMilestoneActivityVariantDefinition>>,
}

impl DestinyPeriodDefinitionsPeriodMilestonesPeriodDestinyMilestoneActivityDefinition {
    /// Milestones can have associated activities which provide additional information about the context, challenges, modifiers, state etc... related to this Milestone.   Information we need to be able to return that data is defined here, along with Tier data to establish a relationship between a conceptual Activity and its difficulty levels and variants.
    pub fn new() -> DestinyPeriodDefinitionsPeriodMilestonesPeriodDestinyMilestoneActivityDefinition {
        DestinyPeriodDefinitionsPeriodMilestonesPeriodDestinyMilestoneActivityDefinition {
