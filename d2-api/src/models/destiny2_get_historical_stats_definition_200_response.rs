...
pub struct Destiny2GetHistoricalStatsDefinition200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodDestinyHistoricalStatsDefinition>>,
...
impl Destiny2GetHistoricalStatsDefinition200Response {
    pub fn new() -> Destiny2GetHistoricalStatsDefinition200Response {
