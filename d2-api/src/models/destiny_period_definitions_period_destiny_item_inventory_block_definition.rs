...
/// DestinyPeriodDefinitionsPeriodDestinyItemInventoryBlockDefinition : If the item can exist in an inventory - the overwhelming majority of them can and do - then this is the basic properties regarding the item's relationship with the inventory.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodDefinitionsPeriodDestinyItemInventoryBlockDefinition {
...
impl DestinyPeriodDefinitionsPeriodDestinyItemInventoryBlockDefinition {
    /// If the item can exist in an inventory - the overwhelming majority of them can and do - then this is the basic properties regarding the item's relationship with the inventory.
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyItemInventoryBlockDefinition {
