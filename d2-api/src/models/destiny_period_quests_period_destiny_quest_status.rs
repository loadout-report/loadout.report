...
/// DestinyPeriodQuestsPeriodDestinyQuestStatus : Data regarding the progress of a Quest for a specific character. Quests are composed of multiple steps, each with potentially multiple objectives: this QuestStatus will return Objective data for the *currently active* step in this quest.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodQuestsPeriodDestinyQuestStatus {
...
impl DestinyPeriodQuestsPeriodDestinyQuestStatus {
    ...
    pub fn new() -> DestinyPeriodQuestsPeriodDestinyQuestStatus {
