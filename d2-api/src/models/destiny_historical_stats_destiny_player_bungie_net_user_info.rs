...
/// DestinyHistoricalStatsDestinyPlayerBungieNetUserInfo : Details about the player as they are known on BungieNet. This will be undefined if the player has marked their credential private, or does not have a BungieNet account.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyHistoricalStatsDestinyPlayerBungieNetUserInfo {
...
impl DestinyHistoricalStatsDestinyPlayerBungieNetUserInfo {
    ...
    pub fn new() -> DestinyHistoricalStatsDestinyPlayerBungieNetUserInfo {
