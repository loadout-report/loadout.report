...
/// DestinyHistoricalStatsDestinyPlayerDestinyUserInfo : Details about the player as they are known in game (platform display name, Destiny emblem)



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyHistoricalStatsDestinyPlayerDestinyUserInfo {
...
impl DestinyHistoricalStatsDestinyPlayerDestinyUserInfo {
    /// Details about the player as they are known in game (platform display name, Destiny emblem)
    pub fn new() -> DestinyHistoricalStatsDestinyPlayerDestinyUserInfo {
