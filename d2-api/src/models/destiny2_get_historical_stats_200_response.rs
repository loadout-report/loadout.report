...
pub struct Destiny2GetHistoricalStats200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<::std::collections::HashMap<String, crate::models::DestinyPeriodHistoricalStatsPeriodDestinyHistoricalStatsByPeriod>>,
...
impl Destiny2GetHistoricalStats200Response {
    pub fn new() -> Destiny2GetHistoricalStats200Response {
