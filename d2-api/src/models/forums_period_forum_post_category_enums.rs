...
pub enum ForumsPeriodForumPostCategoryEnums {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for ForumsPeriodForumPostCategoryEnums {
...
impl Default for ForumsPeriodForumPostCategoryEnums {
    fn default() -> ForumsPeriodForumPostCategoryEnums {
        Self::Variant0
    }
}
