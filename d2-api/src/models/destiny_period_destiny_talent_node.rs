...
pub struct DestinyPeriodDestinyTalentNode {
    ...
    #[serde(rename = "isActivated", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "materialsToUpgrade", skip_serializing_if = "Option::is_none")]
    pub materials_to_upgrade: Option<Vec<crate::models::DestinyPeriodDefinitionsPeriodDestinyMaterialRequirement>>,
    ...
    #[serde(rename = "activationGridLevel", skip_serializing_if = "Option::is_none")]
    pub activation_grid_level: Option<i32>,
    ...
    #[serde(rename = "nodeStatsBlock", skip_serializing_if = "Option::is_none")]
    pub node_stats_block: Option<Box<crate::models::DestinyDestinyTalentNodeNodeStatsBlock>>,
}

impl DestinyPeriodDestinyTalentNode {
    ...
    pub fn new() -> DestinyPeriodDestinyTalentNode {
