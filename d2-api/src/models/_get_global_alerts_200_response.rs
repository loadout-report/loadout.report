...
pub struct GetGlobalAlerts200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<crate::models::GlobalAlert>>,
...
impl GetGlobalAlerts200Response {
    pub fn new() -> GetGlobalAlerts200Response {
