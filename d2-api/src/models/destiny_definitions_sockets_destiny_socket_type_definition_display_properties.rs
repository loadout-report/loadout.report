...
/// DestinyDefinitionsSocketsDestinySocketTypeDefinitionDisplayProperties : There are fields for this display data, but they appear to be unpopulated as of now. I am not sure where in the UI these would show if they even were populated, but I will continue to return this data in case it becomes useful.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsSocketsDestinySocketTypeDefinitionDisplayProperties {
...
impl DestinyDefinitionsSocketsDestinySocketTypeDefinitionDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsSocketsDestinySocketTypeDefinitionDisplayProperties {
