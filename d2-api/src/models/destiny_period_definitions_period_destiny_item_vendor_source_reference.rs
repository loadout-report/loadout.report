...
impl DestinyPeriodDefinitionsPeriodDestinyItemVendorSourceReference {
    ...
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyItemVendorSourceReference {
