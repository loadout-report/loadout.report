...
pub struct GetUserSystemOverrides200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<::std::collections::HashMap<String, crate::models::CommonPeriodModelsPeriodCoreSystem>>,
...
impl GetUserSystemOverrides200Response {
    pub fn new() -> GetUserSystemOverrides200Response {
