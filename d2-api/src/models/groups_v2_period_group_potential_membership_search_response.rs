...
pub struct GroupsV2PeriodGroupPotentialMembershipSearchResponse {
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<crate::models::GroupsV2PeriodGroupPotentialMembership>>,
...
impl GroupsV2PeriodGroupPotentialMembershipSearchResponse {
    pub fn new() -> GroupsV2PeriodGroupPotentialMembershipSearchResponse {
