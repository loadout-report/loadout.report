...
/// DestinyDefinitionsDestinyEntitySearchResultItemDisplayProperties : Basic display properties on the entity, so you don't have to look up the definition to show basic results for the item.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyEntitySearchResultItemDisplayProperties {
...
impl DestinyDefinitionsDestinyEntitySearchResultItemDisplayProperties {
    /// Basic display properties on the entity, so you don't have to look up the definition to show basic results for the item.
    pub fn new() -> DestinyDefinitionsDestinyEntitySearchResultItemDisplayProperties {
