...
/// DestinyDefinitionsDestinyActivityDefinitionDisplayProperties : The title, subtitle, and icon for the activity. We do a little post-processing on this to try and account for Activities where the designers have left this data too minimal to determine what activity is actually being played.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyActivityDefinitionDisplayProperties {
...
impl DestinyDefinitionsDestinyActivityDefinitionDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsDestinyActivityDefinitionDisplayProperties {
