...
/// DestinyDefinitionsDestinyInventoryItemDefinitionAction : If the item can be \"used\", this block will be non-null, and will have data related to the action performed when using the item. (Guess what? 99% of the time, this action is \"dismantle\". Shocker)



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyInventoryItemDefinitionAction {
...
impl DestinyDefinitionsDestinyInventoryItemDefinitionAction {
    ...
    pub fn new() -> DestinyDefinitionsDestinyInventoryItemDefinitionAction {
