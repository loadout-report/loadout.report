...
/// UserPeriodCrossSaveUserMembership : Very basic info about a user as returned by the Account server, but including CrossSave information. Do NOT use as a request contract.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct UserPeriodCrossSaveUserMembership {
...
impl UserPeriodCrossSaveUserMembership {
    ...
    pub fn new() -> UserPeriodCrossSaveUserMembership {
