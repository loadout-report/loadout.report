...
/// DestinyResponsesDestinyErrorProfileInfoCard : Basic info about the account that failed. Don't expect anything other than membership ID, Membership Type, and displayName to be populated.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyResponsesDestinyErrorProfileInfoCard {
...
impl DestinyResponsesDestinyErrorProfileInfoCard {
    ...
    pub fn new() -> DestinyResponsesDestinyErrorProfileInfoCard {
