...
pub struct DestinyPeriodDefinitionsPeriodDestinyStatOverrideDefinition {
    ...
    pub display_properties: Option<Box<crate::models::DestinyDefinitionsDestinyStatOverrideDefinitionDisplayProperties>>,
}

impl DestinyPeriodDefinitionsPeriodDestinyStatOverrideDefinition {
    ...
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyStatOverrideDefinition {
        DestinyPeriodDefinitionsPeriodDestinyStatOverrideDefinition {
            stat_hash: None,
