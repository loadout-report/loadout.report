...
pub struct GroupsV2PeriodGroupSearchResponse {
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<crate::models::GroupsV2PeriodGroupV2Card>>,
...
impl GroupsV2PeriodGroupSearchResponse {
    pub fn new() -> GroupsV2PeriodGroupSearchResponse {
