...
pub enum DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodUnitType {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodUnitType {
...
impl Default for DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodUnitType {
    fn default() -> DestinyPeriodHistoricalStatsPeriodDefinitionsPeriodUnitType {
        Self::Variant0
    }
}
