...
/// DestinyDefinitionsDestinyActivityDefinitionOriginalDisplayProperties : The unadulterated form of the display properties, as they ought to be shown in the Director (if the activity appears in the director).



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyActivityDefinitionOriginalDisplayProperties {
...
impl DestinyDefinitionsDestinyActivityDefinitionOriginalDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsDestinyActivityDefinitionOriginalDisplayProperties {
