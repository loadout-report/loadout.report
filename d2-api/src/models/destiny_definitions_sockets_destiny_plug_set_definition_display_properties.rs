...
/// DestinyDefinitionsSocketsDestinyPlugSetDefinitionDisplayProperties : If you want to show these plugs in isolation, these are the display properties for them.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsSocketsDestinyPlugSetDefinitionDisplayProperties {
...
impl DestinyDefinitionsSocketsDestinyPlugSetDefinitionDisplayProperties {
    /// If you want to show these plugs in isolation, these are the display properties for them.
    pub fn new() -> DestinyDefinitionsSocketsDestinyPlugSetDefinitionDisplayProperties {
