...
pub struct DestinyPeriodDefinitionsPeriodDestinyProgressionDisplayPropertiesDefinition {
    ...
    #[serde(rename = "displayUnitsName", skip_serializing_if = "Option::is_none")]
...
impl DestinyPeriodDefinitionsPeriodDestinyProgressionDisplayPropertiesDefinition {
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyProgressionDisplayPropertiesDefinition {
