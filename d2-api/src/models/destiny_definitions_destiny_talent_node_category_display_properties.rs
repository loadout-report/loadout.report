...
/// DestinyDefinitionsDestinyTalentNodeCategoryDisplayProperties : Will contain at least the \"name\", which will be the title of the category. We will likely not have description and an icon yet, but I'm going to keep my options open.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyTalentNodeCategoryDisplayProperties {
...
impl DestinyDefinitionsDestinyTalentNodeCategoryDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsDestinyTalentNodeCategoryDisplayProperties {
