...
pub struct SearchResultOfContentItemPublicContract {
    ...
    pub results: Option<Vec<crate::models::ContentPeriodContentItemPublicContract>>,
...
impl SearchResultOfContentItemPublicContract {
    pub fn new() -> SearchResultOfContentItemPublicContract {
