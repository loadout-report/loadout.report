...
pub struct DestinyPeriodDefinitionsPeriodMetricsPeriodDestinyMetricDefinition {
    ...
    #[serde(rename = "trackingObjectiveHash", skip_serializing_if = "Option::is_none")]
    pub tracking_objective_hash: Option<i32>,
    #[serde(rename = "lowerValueIsBetter", skip_serializing_if = "Option::is_none")]
    pub lower_value_is_better: Option<bool>,
...
impl DestinyPeriodDefinitionsPeriodMetricsPeriodDestinyMetricDefinition {
    pub fn new() -> DestinyPeriodDefinitionsPeriodMetricsPeriodDestinyMetricDefinition {
        DestinyPeriodDefinitionsPeriodMetricsPeriodDestinyMetricDefinition {
            display_properties: None,
            tracking_objective_hash: None,
            lower_value_is_better: None,
