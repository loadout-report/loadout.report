...
pub struct DestinyDefinitionsMilestonesDestinyMilestoneRewardEntryDefinitionDisplayProperties {
...
impl DestinyDefinitionsMilestonesDestinyMilestoneRewardEntryDefinitionDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsMilestonesDestinyMilestoneRewardEntryDefinitionDisplayProperties {
        DestinyDefinitionsMilestonesDestinyMilestoneRewardEntryDefinitionDisplayProperties {
            description: None,
            name: None,
            icon: None,
