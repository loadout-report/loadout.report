...
pub struct SearchResultOfGroupMemberApplication {
    ...
    pub results: Option<Vec<crate::models::GroupsV2PeriodGroupMemberApplication>>,
...
impl SearchResultOfGroupMemberApplication {
    pub fn new() -> SearchResultOfGroupMemberApplication {
