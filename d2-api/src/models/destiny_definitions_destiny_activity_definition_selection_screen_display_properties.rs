...
/// DestinyDefinitionsDestinyActivityDefinitionSelectionScreenDisplayProperties : The title, subtitle, and icon for the activity as determined by Selection Screen data, if there is any for this activity. There won't be data in this field if the activity is never shown in a selection/options screen.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyActivityDefinitionSelectionScreenDisplayProperties {
...
impl DestinyDefinitionsDestinyActivityDefinitionSelectionScreenDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsDestinyActivityDefinitionSelectionScreenDisplayProperties {
