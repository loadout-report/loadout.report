...
/// DestinyPeriodDefinitionsPeriodDestinyItemInvestmentStatDefinition : Represents a \"raw\" investment stat, before calculated stats are calculated and before any DestinyStatGroupDefinition is applied to transform the stat into something closer to what you see in-game.  Because these won't match what you see in-game, consider carefully whether you really want to use these stats. I have left them in case someone can do something useful or interesting with the pre-processed statistics.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyPeriodDefinitionsPeriodDestinyItemInvestmentStatDefinition {
...
impl DestinyPeriodDefinitionsPeriodDestinyItemInvestmentStatDefinition {
    ...
    pub fn new() -> DestinyPeriodDefinitionsPeriodDestinyItemInvestmentStatDefinition {
