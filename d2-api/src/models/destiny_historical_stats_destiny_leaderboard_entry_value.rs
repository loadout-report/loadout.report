...
pub struct DestinyHistoricalStatsDestinyLeaderboardEntryValue {
...
impl DestinyHistoricalStatsDestinyLeaderboardEntryValue {
    /// Value of the stat for this player
    pub fn new() -> DestinyHistoricalStatsDestinyLeaderboardEntryValue {
