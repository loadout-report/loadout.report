...
/// DestinyEntitiesVendorsDestinyVendorComponentProgression : If the Vendor has a related Reputation, this is the Progression data that represents the character's Reputation level with this Vendor.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyEntitiesVendorsDestinyVendorComponentProgression {
...
impl DestinyEntitiesVendorsDestinyVendorComponentProgression {
    ...
    pub fn new() -> DestinyEntitiesVendorsDestinyVendorComponentProgression {
