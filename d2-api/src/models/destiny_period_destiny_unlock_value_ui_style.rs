...
/// DestinyPeriodDestinyUnlockValueUiStyle : If you're showing an unlock value in the UI, this is the format in which it should be shown. You'll have to build your own algorithms on the client side to determine how best to render these options.
...
pub enum DestinyPeriodDestinyUnlockValueUiStyle {
    #[serde(rename = "0")]
    Variant0,
    #[serde(rename = "1")]
    Variant1,
...
impl ToString for DestinyPeriodDestinyUnlockValueUiStyle {
...
impl Default for DestinyPeriodDestinyUnlockValueUiStyle {
    fn default() -> DestinyPeriodDestinyUnlockValueUiStyle {
        Self::Variant0
    }
}
