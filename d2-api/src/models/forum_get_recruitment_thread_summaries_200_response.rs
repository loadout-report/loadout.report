...
pub struct ForumGetRecruitmentThreadSummaries200Response {
    #[serde(rename = "Response", skip_serializing_if = "Option::is_none")]
    pub response: Option<Vec<crate::models::ForumPeriodForumRecruitmentDetail>>,
...
impl ForumGetRecruitmentThreadSummaries200Response {
    pub fn new() -> ForumGetRecruitmentThreadSummaries200Response {
