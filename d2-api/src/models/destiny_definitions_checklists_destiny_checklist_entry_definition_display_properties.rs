...
/// DestinyDefinitionsChecklistsDestinyChecklistEntryDefinitionDisplayProperties : Even if no other associations exist, we will give you *something* for display properties. In cases where we have no associated entities, it may be as simple as a numerical identifier.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsChecklistsDestinyChecklistEntryDefinitionDisplayProperties {
...
impl DestinyDefinitionsChecklistsDestinyChecklistEntryDefinitionDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsChecklistsDestinyChecklistEntryDefinitionDisplayProperties {
