...
/// DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinitionDisplayProperties : The individual quests may have different definitions from the overall milestone: if there's a specific active quest, use these displayProperties instead of that of the overall DestinyMilestoneDefinition.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinitionDisplayProperties {
...
impl DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinitionDisplayProperties {
    ...
    pub fn new() -> DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinitionDisplayProperties {
