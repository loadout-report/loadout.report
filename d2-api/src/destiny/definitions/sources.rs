...
pub struct ItemSourceDefinition {
    ...
    pub computed_stats: HashMap<super::super::StatHash, super::InventoryItemStatDefinition>,
    /// The DestinyRewardSourceDefinitions found that can spawn the item at this level.
    pub source_hashes: Vec<super::super::RewardSourceHash>,
}
