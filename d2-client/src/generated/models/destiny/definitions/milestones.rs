...
/// If you care about the specific difficulty modes and variations, use the activities under "Variants".
    pub conceptual_activity_hash: crate::id::Id<u32, crate::generated::models::destiny::definitions::DestinyActivityDefinition>,
...
/// If a Milestone could ever split the variants' active status conditionally, they should all have their own DestinyMilestoneActivityDefinition instead! The potential duplication will be worth it for the obviousness of processing and use.
    pub variants: HashMap<u32, crate::generated::models::destiny::definitions::milestones::DestinyMilestoneActivityVariantDefinition>,
}
...
pub struct DestinyMilestoneChallengeDefinition {
    ...
    pub challenge_objective_hash: crate::id::Id<u32, crate::generated::models::destiny::definitions::DestinyObjectiveDefinition>,
}
...
/// As of Forsaken (~September 2018), Quest-style Milestones are being removed for many types of activities. There will likely be further revisions to the Milestone concept in the future.
    pub quests: HashMap<u32, crate::generated::models::destiny::definitions::milestones::DestinyMilestoneQuestDefinition>,
...
/// This is keyed by the Category's hash, which is only guaranteed to be unique within a given Milestone.
    pub rewards: HashMap<u32, crate::generated::models::destiny::definitions::milestones::DestinyMilestoneRewardCategoryDefinition>,
    ...
    pub values: HashMap<String, crate::generated::models::destiny::definitions::milestones::DestinyMilestoneValueDefinition>,
...
pub struct DestinyMilestoneQuestDefinition {
    ...
    pub activities: HashMap<u32, crate::generated::models::destiny::definitions::milestones::DestinyMilestoneActivityDefinition>,
...
pub struct DestinyMilestoneRewardCategoryDefinition {
    ...
    pub reward_entries: HashMap<u32, crate::generated::models::destiny::definitions::milestones::DestinyMilestoneRewardEntryDefinition>,
}
